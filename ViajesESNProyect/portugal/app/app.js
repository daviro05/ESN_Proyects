    ...
    switch (numero) {
        ...
        case 1:
            ...
            " 1. LISBOA\n Lisboa es la capital​ y mayor ciudad de Portugal."+
             ...
             "\n\n La ciudad de Lisboa refleja a la perfección el estilo de vida portugués, que se entrega a la "+
             " cultura moderna sin dejar de mantener su herencia y tradiciones únicas. Lisboa es reconocida "+
             " constantemente como una de las ciudades más increíbles del mundo, una pretensión confirmada por "+
             " las guías de viajes “Lonely Planet”, que designaron a Lisboa como una de las 10 mejores ciudades "+
             " que visitar en todo el mundo. Por todo ello, ¡no deja de resultar sorprendente que siga siendo una "+
             " de las capitales menos visitadas de Europa!";
            break;
